...
export class ModelConfigManager {
  ...
  throwErrorIfNonVLModel() {
    ...
    if (!modelConfig.modelFamily) {
      throw new Error(
        'MIDSCENE_MODEL_FAMILY is not set to a visual language model (VL model), the element localization can not be achieved. Check your model configuration. See https://sqai.tech/model-strategy.html',
      );
    }
  }
}
