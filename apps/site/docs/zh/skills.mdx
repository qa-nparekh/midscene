...
| Skill | 包名 | CLI 命令 | 说明 |
|-------|------|----------|------|
| Browser Automation | `@sqaitech/web` | `npx @sqaitech/web` | 通过 Puppeteer 的无头 Chrome，打开新浏览器标签页 |
| Chrome Bridge Automation | `@sqaitech/web` | `npx @sqaitech/web --bridge` | 使用用户自己的 Chrome 浏览器，保留 Cookie 和会话 |
| Desktop Computer Automation | `@sqaitech/computer` | `npx @sqaitech/computer` | macOS、Windows、Linux 桌面控制 |
| Android Device Automation | `@sqaitech/android` | `npx @sqaitech/android` | 通过 ADB 控制 Android 设备 |
| iOS Device Automation | `@sqaitech/ios` | `npx @sqaitech/ios` | 通过 WebDriverAgent 控制 iOS 设备 |
