...
## v1.2 - File upload support and stability improvements

v1.2 focuses on expanding Web automation capabilities and improving overall stability. It adds file upload functionality and fixes several issues affecting user experience, making automated testing more reliable.
