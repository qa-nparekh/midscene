...
<PackageManagerTabs command="install @sqai/ios --save-dev" />
...
```typescript
import { IOSAgent, IOSDevice, agentFromWebDriverAgent } from '@sqai/ios';
...
import { IOSAgent, IOSDevice } from '@sqai/ios';
...
import { IOSDevice, IOSAgent } from '@sqai/ios';
