...
<PackageManagerTabs command="install @sqaitech/web puppeteer tsx --save-dev" />
...
<PackageManagerTabs command="install puppeteer @sqaitech/web --save-dev" />
...
- For the Puppeteer API reference, see [Puppeteer Agent API](http://localhost:3000/web-api-reference.html#puppeteer-agent).
- Demo projects
