...
Add the Midscene MCP server to your MCP configuration, note that the `SQAI_MCP_ANDROID_MODE` environment variable is required:
...
```json
{
  "mcpServers": {
    "mcp-midscene": {
      ...
      "args": ["-y", "@sqaitech/mcp"],
      "env": {
        "SQAI_MODEL_NAME": "REPLACE_WITH_YOUR_MODEL_NAME",
        "OPENAI_API_KEY": "REPLACE_WITH_YOUR_OPENAI_API_KEY",
        "SQAI_MCP_ANDROID_MODE": "true",
