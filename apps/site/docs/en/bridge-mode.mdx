...
<PackageManagerTabs command="install @sqaitech/web tsx --save-dev" />
...
* Where should I config the model parameters (like `SQAI_MODEL_API_KEY`), in the browser or in the terminal?
