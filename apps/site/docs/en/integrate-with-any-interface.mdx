...
```typescript
import type { DeviceAction, Size } from '@sqaitech/core';
...
import type { AbstractInterface } from '@sqaitech/core';
```
...
```typescript
import { AbstractInterface } from '@sqaitech/core';
```
...
```ts
import type { DeviceAction, Size, UIContext } from '@sqaitech/core';
...
```typescript
import { getMidsceneLocationSchema } from "@sqaitech/core/device";
