...
```typescript
import type { DeviceAction, Size } from '@sqai/core';
...
```typescript
import { AbstractInterface } from '@sqai/core';
```
...
```ts
import type { DeviceAction, Size, UIContext } from '@sqai/core';
...
```typescript
import { getMidsceneLocationSchema } from "@sqai/core/device";
