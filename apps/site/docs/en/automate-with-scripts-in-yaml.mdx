  ...
  - name: <name>
    ...
    flow:
      ...
      - ai: <prompt>
        ...
        deepThink: <boolean> # Optional, enable deep thinking for planning when the model supports it (depends on SQAI_MODEL_FAMILY). Default is undefined and follows the model provider's default strategy.
